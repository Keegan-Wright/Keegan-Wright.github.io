    ...
    return (
        <div
            ...
            <header
                ...
                aria-label={`${textResources[PersonalProjectFields.Name]}`}>{`Image to go here`}
            </header>
                ...
                <h3 className="font-medium leading-snug text-slate-200">
                    <div>
                        ...
                        <a
                            ...
                            href={textResources[PersonalProjectFields.GithubLink]} target="_blank" rel="noreferrer noopener"
                            aria-label="Senior Frontend Engineer, Accessibility at Klaviyo (opens in a new tab)"><span
                            className="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span> <span>{textResources[PersonalProjectFields.Name]} <span className="inline-block"> <svg xmlns="http://www.w3.org/2000/svg"
