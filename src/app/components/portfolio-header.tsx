    ...
    return (
        ...
        >
            <motion.div variants={slideInFromLeft}>
                <motion.h1 className="text-4xl font-bold tracking-tight text-slate-300 sm:text-5xl"><a
                    href="/">{firstName} {lastName}</a>
                </motion.h1>
                <motion.h2 variants={slideInFromLeft}
                           className="mt-3 text-lg font-medium tracking-tight text-slate-300 sm:text-xl">{jobTitle}</motion.h2>
                ...
                <motion.nav variants={slideInFromLeft} className="nav hidden lg:block" aria-label="In-page jump links">
                    <ul className="mt-16 w-60">
                        <li>
                            <a
                            className={`group flex items-center justify-between py-3 ${currentActiveSection === '#about' ? 'active' : ''}`}
                            href="#about">
                                <span
                            className="nav-indicator mr-4 h-px w-8 bg-slate-600 transition-all group-hover:w-16 group-hover:bg-purple-400 group-focus-visible:w-16 group-focus-visible:bg-purple-400 motion-reduce:transition-none"/>
                                <span
                                    className="nav-text text-xs font-bold uppercase tracking-widest text-slate-500 group-hover:text-purple-400 group-focus-visible:text-purple-400">About Me</span>
                                <span
                                    className="nav-indicator ml-4 h-px w-8 bg-slate-600 transition-all group-hover:w-16 group-hover:bg-purple-400 group-focus-visible:w-16 group-focus-visible:bg-purple-400 motion-reduce:transition-none"></span>

                            </a>
                        </li>
                        <li><a
                            className={`group flex items-center justify-between py-3 ${currentActiveSection === '#experience' ? 'active' : ''}`}
                            href="#experience"><span
                            ...
                            className="nav-text text-xs font-bold uppercase tracking-widest text-slate-500 group-hover:text-purple-400 group-focus-visible:text-purple-400">Experience</span>
                            <span
                                className="nav-indicator ml-4 h-px w-8 bg-slate-600 transition-all group-hover:w-16 group-hover:bg-purple-400 group-focus-visible:w-16 group-focus-visible:bg-purple-400 motion-reduce:transition-none"></span>
                        </a>
                        </li>
                        <li><a
                            className={`group flex items-center justify-between py-3 ${currentActiveSection === '#personal-projects' ? 'active' : ''}`}
                            href="#personal-projects">
                            <span
                                className="nav-indicator mr-4 h-px w-8 bg-slate-600 transition-all group-hover:w-16 group-hover:bg-purple-400 group-focus-visible:w-16 group-focus-visible:bg-purple-400 motion-reduce:transition-none"></span>
                            <span
                                className="nav-text text-xs font-bold uppercase tracking-widest text-slate-500 group-hover:text-purple-400 group-focus-visible:text-purple-400">Projects                            </span>
                            <span
                                className="nav-indicator ml-4 h-px w-8 bg-slate-600 transition-all group-hover:w-16 group-hover:bg-purple-400 group-focus-visible:w-16 group-focus-visible:bg-purple-400 motion-reduce:transition-none"></span>
                        </a>
                        </li>
            ...
            <motion.ul variants={slideInFromLeft} className="ml-1 mt-8 flex items-center" aria-label="Social media">
                ...
                <li className="mr-5 shrink-0 text-xs"><a className="block hover:text-purple-400"
                    ...
                    <svg fill="currentColor" className="h-6 w-6" viewBox="0 0 1024 1024"
