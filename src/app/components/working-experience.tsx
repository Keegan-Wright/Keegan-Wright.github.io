                ...
                <h3 className="font-medium leading-snug text-slate-200">
                    <div>
                        ...
                        <a
                            ...
                            href={textResources[WorkExperienceFields.employerUrl]} target="_blank" rel="noreferrer noopener"
                            aria-label="Senior Frontend Engineer, Accessibility at Klaviyo (opens in a new tab)"><span
                            className="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span> <span>{textResources[WorkExperienceFields.jobTitle]} @ <span className="inline-block"> {textResources[WorkExperienceFields.employerName]} <svg xmlns="http://www.w3.org/2000/svg"
