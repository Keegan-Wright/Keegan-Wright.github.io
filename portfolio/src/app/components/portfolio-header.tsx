    ...
    return (
        <div>
            <div><h1 className="text-4xl font-bold tracking-tight text-slate-300 sm:text-5xl"><a href="/">{firstName} {lastName}</a>
            </h1><h2 className="mt-3 text-lg font-medium tracking-tight text-slate-300 sm:text-xl">{jobTitle}</h2><p
                className="mt-4 max-w-xs leading-normal">{personalIntro}</p>
                <nav className="nav hidden lg:block" aria-label="In-page jump links">
                    <ul className="mt-16 w-max">
                        <li><a className={`group flex items-center py-3 ${activeSection === '#about' ? 'active' : ''}`} href="#about"><span
                        ...
                        <li><a className={`group flex items-center py-3 ${activeSection === '#experience' ? 'active' : ''}`} href="#experience"><span
                            className="nav-indicator mr-4 h-px w-8 bg-slate-600 transition-all group-hover:w-16 group-hover:bg-slate-200 group-focus-visible:w-16 group-focus-visible:bg-slate-200 motion-reduce:transition-none"></span><span
                        ...
                        <li><a className={`group flex items-center py-3 ${activeSection === '#personal-projects' ? 'active' : ''}`} href="#personal-projects"><span
                            className="nav-indicator mr-4 h-px w-8 bg-slate-600 transition-all group-hover:w-16 group-hover:bg-slate-200 group-focus-visible:w-16 group-focus-visible:bg-slate-200 motion-reduce:transition-none"></span><span
